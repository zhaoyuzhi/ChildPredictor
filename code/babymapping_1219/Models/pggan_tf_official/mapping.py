    ...
    def forward(self, x_father, x_mother):
        ...
        if self.output_norm:
            for i in range(self.out_num):
                ...
                out[:, (self.out_num * i):(self.out_num * (i + 1))] = \
                    (out[:, (self.out_num * i):(self.out_num * (i + 1))] - out[:, (self.out_num * i):(self.out_num * (i + 1))].mean(dim=1).reshape(out[:, (self.out_num * i):(self.out_num * (i + 1))].shape[0], 1)) / out[:, (self.out_num * i):(self.out_num * (i + 1))].var(dim=1).reshape(out[:, (self.out_num * i):(self.out_num * (i + 1))].shape[0], 1)
