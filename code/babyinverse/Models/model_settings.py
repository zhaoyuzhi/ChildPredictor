...
MODEL_POOL = {
    ...
    'pggan_baby':{
        'tf_model_path': MODEL_DIR + 'pggan_tf_without_msgan.pkl',
        'model_path': MODEL_DIR + 'ProGAN_pt_mixtureData_GAN_MSGAN_ACGAN.pth',
        'gan_type': 'pggan',
        'dataset_name': 'baby',
        'latent_space_dim': 512,
        'resolution': 128,
    ...
    'pggan_baby2':{
        'tf_model_path': MODEL_DIR + 'pggan_tf_without_msgan.pkl',
        'model_path': MODEL_DIR + 'pggan_baby_pt_without_msgan.pth',
        'gan_type': 'pggan',
        'dataset_name': 'baby',
        'latent_space_dim': 512,
        'resolution': 128,
...
STYLEGAN_RANDOMIZE_NOISE = True

# Settings for model running.
USE_CUDA = True

MAX_IMAGES_ON_DEVICE = 50
