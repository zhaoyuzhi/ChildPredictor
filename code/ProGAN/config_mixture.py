...
desc += '-baby';            dataset = EasyDict(tfrecord_dir='mixtureFace'); train.mirror_augment = True
dataset.max_label_size='full' #'full' for label
#train.resume_run_id = './ckp/network-final.pkl'
train.G_ex = ['lod']
train.D_ex = ['lod', '4x4/Dense0/weight', '4x4/Dense0/bias', '4x4/Dense1/weight', '4x4/Dense1/bias']
...
desc += '-preset-v2-1gpu'; num_gpus = 8; sched.minibatch_base = 4; sched.minibatch_dict = {4: 256, 8: 256, 16: 256, 32: 128, 64:64, 128: 32, 256: 16, 512: 8}; sched.G_lrate_dict = {128: 0.0015, 1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
